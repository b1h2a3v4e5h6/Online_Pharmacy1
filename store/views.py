...
class ProductView(View):
    def get(self, request):
        ...
        'immunity_boosters':immunity_boosters,'medicines':medicines, 'totalitem':totalitem})
...
class ProfileView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            reg = Customer(user=usr, name=name, mobile=mobile, city=city, area=area, pincode=pincode)
            reg.save()
...
class updateAddress(View):
    ...
    def post(self,request,pk):
        ...
        if form.is_valid():
            ...
            message.error(request,"Invalid Input Data")
